...
--
---- yank and stay at the bottom
vim.keymap.set("v", "y", "ygv",{desc='Stay selected when yanking blocks', noremap = true, silent = true}) -- doesn't work yet
--
---- Terminal --
...
}},
{
  ...
  {'windwp/nvim-autopairs', -- auto make the other pair
  event = "InsertEnter",
  config = true,
  opts={}},
