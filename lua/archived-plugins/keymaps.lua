...
vim.keymap.set({ "n" }, "<leader><BS>", function()
	if vim.fn.bufnr("#") == -1 then
		...
		vim.cmd("e #") -- Switch to the alternate buffer
	end
...
-- Removed obsidian daily notes functions (external dependency)
...
-- Removed zsh sourcing keymap (shell-specific dependency)

-- Removed external script dependency (400-autoPushGithub.sh)
